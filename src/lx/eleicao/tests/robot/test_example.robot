...
#
#  $ bin/test -s lx.eleicao -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src lx.eleicao.testing.LX_ELEICAO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/lx/eleicao/tests/robot/test_example.robot
#
